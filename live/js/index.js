...
var front = {
  ...
  data() {
    return {
      config: {
        event_id: "D2449",
        event_code: "live",
        discount_code: "Live202003",
        end_date: "2020-04-16 10:00:00",
        uid: "",
        t: "",
        hash: "",
        isBinded: 999
  ...
  computed: {
    ...
    event_url() {
      return this.testMode ? "https://line.franklin.com.tw:8688/bcsweb/l/16" : "https://line.franklin.com.tw/bcsweb/l/112";
    },
    isLine() {
