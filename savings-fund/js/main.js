...
Vue.component("footer-warning", {
    ...
    template: `<div class="footer-warning">
       ...
       本公司所提供之資訊，僅供接收人之參考用途。本公司當盡力提供正確之資訊，所載資料均來自或本諸我們相信可靠之來源，但對其完整性、即時性和正確性不做任何擔保，如有錯漏或疏忽，本公司或關係企業與其任何董事或受僱人，並不負任何法律責任。任何人因信賴此等資料而做出或改變投資決策，須自行承擔結果。本網頁所載資料或任何部份均不可以進行抄錄、翻印或另作派發。
                        ...
                        <li>
                有關基金所應承擔之相關風險及應負擔之費用(含分銷費用)已揭露於基金公開說明書及投資人須知中，投資人可至基金資訊觀測站(<sice-web-link href="http://www.fundclear.com.tw" target="_blank">http://www.fundclear.com.tw</sice-web-link>)下載，或逕向本公司網站(<sice-web-link href="https://www.franklin.com.tw" target="_blank">https://www.franklin.com.tw</sice-web-link>)查閱。
                        </li>
                        <li>
    基金的配息可能由基金的收益或本金中支付。任何涉及由本金支出的部份，可能導致原始投資金額減損。部份基金進行配息前未先扣除應負擔之費用。由本金支付配息之相關資料已揭露於本公司網站，投資人可至本公司網站(<sice-web-link href = "https://www.franklin.com.tw" target = "_blank" > https://www.franklin.com.tw</sice-web-link>)查閱。基金配息率不代表基金報酬率，且過去配息率不代表未來配息率；基金淨值可能因市場因素而上下波動，投資人於獲配息時，宜一併注意基金淨值之變動。
                        </li>
                    </ul>
                </div> `
});
