...
Vue.component("form-post", {
  ...
  computed: {
    action() {
      ...
      switch (this.landing) {
        case "choice":
          url = "https://etrade.franklin.com.tw/Open/Entrance";
          break;
        case "send":
          url = "https://etrade.franklin.com.tw/Open/NewMember?so=Online&";
          break;
        case "online":
          url = "https://etrade.franklin.com.tw/Open/OpenOnlineAuthenticated?";
          break;
      }
      return url;
    },
...
var front = {
  ...
  computed: {
    ...
    event_url() {
      return this.testMode
        ? "https://line.franklin.com.tw:8443/Tag/Bind/DR?id=savingreservation"
        : "https://line.franklin.com.tw:8843/Tag/Bind/DR?id=savingreservation";
    },
    isLine() {
    ...
    isPart2() {
      ...
      return moment(new Date()).isSameOrAfter(this.config.start_date);
    },
    isEnd() {
      // 2020-06-19 活動結束後會以原頁面更新, 故不做活動結束判斷
      return false;
  ...
  created() {
    ...
    // 修正safari會錯誤的問題
    // this.$nextTick(() => {
    if (this.isLine && !this.isEnd && this.isPart2) {
