...
Vue.component("footer-warning", {
    ...
    template: `<div class="footer-warning">
                    <ul>
                        ...
                        <li>
                            基金的配息可能由基金的收益或本金中支付。部分基金進行配息前未先扣除應負擔之費用。任何涉及由本金支出的部份，可能導致原始投資金額減損。由本金支付配息之相關資料已揭露於本公司網站，投資人可至本公司網站(<sice-web-link href="https://www.franklin.com.tw" target="_blank">https://www.franklin.com.tw</sice-web-link>)查閱。
                        </li>
                        <li>
                            投資基金所應承擔之相關風險及應負擔之費用(含分銷費用)已揭露於基金公開說明書及投資人須知中，投資人可至境外基金資訊觀測站(<sice-web-link href="https://www.fundclear.com.tw/" target="_blank">https://www.fundclear.com.tw/</sice-web-link>)下載，或逕向本公司網站(<sice-web-link href="https://www.franklin.com.tw/" target="_blank">https://www.franklin.com.tw/</sice-web-link>)查閱。【富蘭克林證券投顧獨立經營管理】
                        </li>
                    </ul>
                </div>`
});
